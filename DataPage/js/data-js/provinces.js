var dom = document.getElementById("provinces");
var myChart = echarts.init(dom,'chalk');
var app = {};
option = null;
var dataMap = {};
//白色为感冒，黄色为手足口病，蓝色为登革热
...
dataMap.dataPI = dataFormatter1(data.流行性感冒)
dataMap.dataSI = dataFormatter1(data.手足口病)
dataMap.dataTI = dataFormatter1(data.登革热)
...
option = {
    baseOption: {
        timeline: {//设置时间线
            ...
            itemStyle:{//菱形的颜色
                color: {
                    ...
                    y2: 1,
                    colorStops: [{
                        offset: 0, color: '#3C8CE7' // 0% 处的颜色
                    }, {
                        offset: 1, color: '#00EAFF' // 100% 处的颜色
                    }],
                    global: false // 缺省为 false
                }
            },
        ...
        series: [
            ...
            {name: '金融', type: 'bar'},
            {name: '房地产', type: 'bar'},
            {name: '流行性感冒', type: 'scatter',itemStyle:itemStyleDefault1},
            {name: '手足口病', type: 'scatter',itemStyle:itemStyleDefault2},
            {name: '登革热', type: 'scatter',itemStyle:itemStyleDefault3},
            {
                ...
                itemStyle:{
                    normal:{
                        ...
                        //自定义颜色
                            var colorList = [          
                                 'white', '#FFFF00', '#00FFFF','#FF8C00', '#FF0000', '#FE8463',
                            ];
    ...
    options: [
        {
            ...
            series : [
                ...
                {data: [
                    {name: '流行性感冒', value: dataMap.dataPI['2005sum']},
                    {name: '手足口病', value: dataMap.dataSI['2005sum']},
                    {name: '登革热', value: dataMap.dataTI['2005sum']}
                ]}
            ]
        },
        {
            title : {text: '2006年传染病大数据散点图'},
            series : [
                ...
                {data: [
                    {name: '流行性感冒', value: dataMap.dataPI['2006sum']},
                    {name: '手足口病', value: dataMap.dataSI['2006sum']},
                    {name: '登革热', value: dataMap.dataTI['2006sum']}
                ]}
            ]
        },
        {
            title : {text: '2007年传染病大数据散点图'},
            series : [
                ...
                {data: [
                    {name: '流行性感冒', value: dataMap.dataPI['2007sum']},
                    {name: '手足口病', value: dataMap.dataSI['2007sum']},
                    {name: '登革热', value: dataMap.dataTI['2007sum']}
                ]}
            ]
        },
        {
            title : {text: '2008年传染病大数据散点图'},
            series : [
                ...
                {data: [
                    {name: '流行性感冒', value: dataMap.dataPI['2008sum']},
                    {name: '手足口病', value: dataMap.dataSI['2008sum']},
                    {name: '登革热', value: dataMap.dataTI['2008sum']}
                ]}
            ]
        },
        {
            title : {text: '2009年传染病大数据散点图'},
            series : [
                ...
                {data: [
                    {name: '流行性感冒', value: dataMap.dataPI['2009sum']},
                    {name: '手足口病', value: dataMap.dataSI['2009sum']},
                    {name: '登革热', value: dataMap.dataTI['2009sum']}
                ]}
            ]
        },
        {
            title : {text: '2010年传染病大数据散点图'},
            series : [
                ...
                {data: [
                    {name: '流行性感冒', value: dataMap.dataPI['2010sum']},
                    {name: '手足口病', value: dataMap.dataSI['2010sum']},
                    {name: '登革热', value: dataMap.dataTI['2010sum']}
                ]}
            ]
        },
        {
            title : {text: '2011年传染病大数据散点图'},
            series : [
                ...
                {data: [
                    {name: '流行性感冒', value: dataMap.dataPI['2011sum']},
                    {name: '手足口病', value: dataMap.dataSI['2011sum']},
                    {name: '登革热', value: dataMap.dataTI['2011sum']}
                ]}
            ]
        },
        {
            title : {text: '2012年传染病大数据散点图'},
            series : [
                ...
                {data: [
                    {name: '流行性感冒', value: dataMap.dataPI['2012sum']},
                    {name: '手足口病', value: dataMap.dataSI['2012sum']},
                    {name: '登革热', value: dataMap.dataTI['2012sum']}
                ]}
            ]
        },
        {
            title : {text: '2013年传染病大数据散点图'},
            series : [
                ...
                {data: [
                    {name: '流行性感冒', value: dataMap.dataPI['2013sum']},
                    {name: '手足口病', value: dataMap.dataSI['2013sum']},
                    {name: '登革热', value: dataMap.dataTI['2013sum']}
                ]}
            ]
        },
        {
            title : {text: '2014年传染病大数据散点图'},
            series : [
                ...
                {data: [
                    {name: '流行性感冒', value: dataMap.dataPI['2014sum']},
                    {name: '手足口病', value: dataMap.dataSI['2014sum']},
                    {name: '登革热', value: dataMap.dataTI['2014sum']}
                ]}
            ]
        },
        {
            title: {text: '2015年传染病大数据散点图'},
            series: [
                ...
                {data: [
                    {name: '流行性感冒', value: dataMap.dataPI['2015sum']},
                    {name: '手足口病', value: dataMap.dataSI['2015sum']},
                    {name: '登革热', value: dataMap.dataTI['2015sum']}
                ]}
            ]
        }
    ]
